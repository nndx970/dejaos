/**
 * @file lv_conf.h
 * Configuration file for v8.3.10-dev
 */
...
#  define LV_MEM_SIZE (30 * 1024U * 1024U)          /*[bytes]*/
...
#define LV_MEM_BUF_MAX_NUM  128//16
...
#define LV_DISP_ROT_MAX_BUF (1920*1080*4) //(10*1024)
...
#define LV_USE_FS_STDIO 0
    ...
    #define LV_FS_STDIO_CACHE_SIZE (500*400*4)  /*>0 to cache this number of bytes in lv_fs_read()*/
#endif
