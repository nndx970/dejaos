...
// VF202-继电器GPIO
const relayGpio = 67;
const GPIO_OUTPUT0 = 0x04;// 0100, GPIO output low  level
const GPIO_OUTPUT1 = 0x05;// 0101, GPIO output high level
function setRelayStatus(status) {
    initGpio();
    requestGpio(relayGpio);
    setFuncGpio(relayGpio, status ? GPIO_OUTPUT1 : GPIO_OUTPUT0);
}
