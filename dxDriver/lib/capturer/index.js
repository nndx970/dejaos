...
const capturerRgbDeinit = new FFI.CFunction(
    capturerLib.symbol('capturer_rgb_deinit'),
    FFI.types.void,
    []
);

const capturerNirDeinit = new FFI.CFunction(
    capturerLib.symbol('capturer_nir_deinit'),
    FFI.types.void,
    []
);
...
function capturerDeinit() {
    capturerRgbDeinit.call();
    capturerNirDeinit.call();
}


export { capturerInit, capturerDeinit };